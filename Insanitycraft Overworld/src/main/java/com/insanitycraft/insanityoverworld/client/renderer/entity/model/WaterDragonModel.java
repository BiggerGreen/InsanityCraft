...
public class WaterDragonModel<T extends WaterDragonEntity> extends SegmentedModel<T> {
    ...
    public WaterDragonModel() {
        ...
        this.HeadTopP2.func_228301_a_(-6.0F, 0.0F, 0.0F, 12, 26, 9, 0.0F);
        ...
        this.HeadP6.func_228301_a_(-7.5F, -1.0F, -3.0F, 15, 16, 16, 0.0F);
        this.FinLeft_1 = new ModelRenderer(this, 150, 0);
        this.FinLeft_1.setRotationPoint(8.0F, 0.0F, 0.0F);
        this.FinLeft_1.func_228301_a_(-4.0F, -1.0F, -9.0F, 30, 2, 19, 0.0F);
        ...
        this.HeadP4.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 16, 4, 0.0F);
        ...
        this.TorsoP1.func_228301_a_(-10.0F, -8.5F, -15.0F, 20, 17, 30, 0.0F);
        this.HeadP3 = new ModelRenderer(this, 0, 100);
        this.HeadP3.mirror = true;
        this.HeadP3.setRotationPoint(2.5F, 3.5F, -2.0F);
        this.HeadP3.func_228301_a_(0.0F, 0.0F, 0.0F, 4, 16, 4, 0.0F);
        ...
        this.NeckP2.func_228301_a_(-5.0F, -7.0F, -18.0F, 10, 14, 19, -0.1F);
        ...
        this.NeckP1.func_228301_a_(-7.5F, -8.0F, -12.0F, 15, 16, 14, 0.0F);
        ...
        this.HeadJoint.func_228301_a_(0.0F, 0.0F, 0.0F, 1, 1, 1, 0.0F);
        this.HeadJawP1 = new ModelRenderer(this, 50, 70);
        this.HeadJawP1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.HeadJawP1.func_228301_a_(-6.0F, -5.5F, -2.0F, 12, 24, 4, 0.0F);
        ...
        this.TailP3.func_228301_a_(-4.0F, -4.0F, 0.0F, 8, 8, 15, 0.0F);
    ...
    @Override
    public void func_225597_a_(WaterDragonEntity p_225597_1_, float p_225597_2_, float p_225597_3_, float p_225597_4_, float p_225597_5_, float p_225597_6_) {
