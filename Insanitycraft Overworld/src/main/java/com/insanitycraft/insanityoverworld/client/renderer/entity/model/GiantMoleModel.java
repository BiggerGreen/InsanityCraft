...
//	private final ModelRenderer bone10;
	...
	public GiantMoleModel () {
		...
		body.func_228301_a_(-4.0F, -3.25F, 8.6667F, 8, 7, 2, 0.0F);
		...
		nose.func_228301_a_(2.0F, -3.5F, -5.9375F, 3, 1, 1, 0.0F);
		nose.func_228301_a_(2.0F, -1.5F, -5.9375F, 3, 1, 1, 0.0F);
		nose.func_228301_a_(-5F, -3.5F, -5.9375F, 3, 1, 1, 0.0F);
		nose.func_228301_a_(-5F, -1.5F, -5.9375F, 3, 1, 1, 0.0F);
...
//		nose.func_228301_a_(4.5F, 2.0F, -0.5F, 1, 3, 1, 0.0F);
		...
		noseNipple.func_228301_a_(1,1,1,1,1,1, 0.0F);
...
//		nose.addChild(bone10);
		...
		foot2.func_228301_a_(-1.5F, -0.5F, 0.1667F, 3, 1, 5, 0.0F);
		foot2.setTextureOffset(16, 39);
		foot2.func_228301_a_(-1.5F, -0.5F, -2.8333F, 1, 1, 3, 0.0F);
		foot2.func_228301_a_(0.5F, -0.5F, -2.8333F, 1, 1, 3, 0.0F);

		foot3 = new ModelRenderer(this, 0, 0);
		foot3.setRotationPoint(-5.5F, 23.5F, 5.8333F);
		foot3.setTextureOffset(0, 37);
		foot3.func_228301_a_(-1.5F, -0.5F, -2.8333F, 3, 1, 5, 0.0F);
		foot3.setTextureOffset(16, 39);
		foot3.func_228301_a_(-1.5F, -0.5F, -5.8333F, 1, 1, 3, 0.0F);
		foot3.func_228301_a_(0.5F, -0.5F, -5.8333F, 1, 1, 3, 0.0F);

		foot4 = new ModelRenderer(this, 0, 0);
		foot4.setRotationPoint(5.5F, 23.5F, 5.8333F);
		foot4.setTextureOffset(0, 37);
		foot4.func_228301_a_(-1.5F, -0.5F, -2.8333F, 3, 1, 5, 0.0F);
		foot4.setTextureOffset(16, 39);
		foot4.func_228301_a_(-1.5F, -0.5F, -5.8333F, 1, 1, 3, 0.0F);
		foot4.func_228301_a_(0.5F, -0.5F, -5.8333F, 1, 1, 3, 0.0F);
	}
